...
const VIDEO_GLYPH_PLAY =
  'M0 14.1152V1.54688C0 1.02539 0.134766 0.638672 0.404297 0.386719C0.673828 0.128906 0.993164 0 1.3623 0C1.69043 0 2.01562 0.09375 2.33789 0.28125L12.832 6.39844C13.2188 6.62695 13.5 6.84668 13.6758 7.05762C13.8574 7.26855 13.9482 7.52637 13.9482 7.83105C13.9482 8.12988 13.8574 8.3877 13.6758 8.60449C13.5 8.81543 13.2188 9.03223 12.832 9.25488L2.33789 15.3809C2.01562 15.5684 1.69043 15.6621 1.3623 15.6621C0.993164 15.6621 0.673828 15.5332 0.404297 15.2754C0.134766 15.0176 0 14.6309 0 14.1152Z';
const VIDEO_GLYPH_PLAY_TRANSFORM = 'translate(13.091 11.365) scale(0.8474)';
...
document.querySelectorAll('[data-video-teaser]').forEach((wrapper) => {
  ...
  const setIcon = (playing) => {
    ...
    if (playing) {
      ...
      glyph.setAttribute('transform', VIDEO_GLYPH_PLAY_TRANSFORM);
    }
